  ...
  function _handleSubmit() {
    _handleSubmit = _asyncToGenerator(function* (evt) {
      ...
      try {
        ...
        const user = yield (0,_utilities_users_service__WEBPACK_IMPORTED_MODULE_1__.logIn)(credentials);
        setUser(user);
      } catch (_unused) {
...
function Logo() {
  ...
  }, /*#__PURE__*/React.createElement("h1", null, "Art Supplies"));
}
    ...
    _defineProperty(this, "handleSubmit", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(function* (evt) {
        ...
        try {
          ...
          // will resolve to the user object included in the
          // payload of the JSON Web Token (JWT)
          const user = yield (0,_utilities_users_service__WEBPACK_IMPORTED_MODULE_1__.create)(formData);
          // Baby step
          console.log(user);
...
const root = react_dom_client__WEBPACK_IMPORTED_MODULE_2__.createRoot(document.getElementById('app'));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AuthPage.modules.scss */ "./src/pages/AuthPage/AuthPage.modules.scss");
...
function AuthPage(_ref) {
  ...
  return /*#__PURE__*/React.createElement("main", {
    className: _AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_1__["default"].AuthPage
  }, /*#__PURE__*/React.createElement("div", {
    className: _AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_1__["default"].AuthTop
  }, /*#__PURE__*/React.createElement("div", {
    className: _AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_1__["default"].AuthPageLogo
    ...
    className: _AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_1__["default"].BoldWhiteText,
...
function OrderHistoryPage(_ref) {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_Logo_Logo__WEBPACK_IMPORTED_MODULE_2__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_7__.Link, {
    to: "/orders/new",
    className: "button btn-sm"
  }, "NEW ORDER"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_UserLogOut_UserLogOut__WEBPACK_IMPORTED_MODULE_3__["default"], {
    user: user,
    setUser: setUser
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_OrderList_OrderList__WEBPACK_IMPORTED_MODULE_4__["default"], {
    orders: orders,
    activeOrder: activeOrder,
    handleSelectOrder: handleSelectOrder
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_OrderDetail_OrderDetail__WEBPACK_IMPORTED_MODULE_5__["default"], {
    order: activeOrder
  }));
}
...
/* harmony export */ });
/* harmony import */ var _token__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./token */ "./src/utilities/token.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
function _sendRequest() {
  _sendRequest = _asyncToGenerator(function (url) {
    ...
    return function* () {
      ...
      const token = (0,_token__WEBPACK_IMPORTED_MODULE_0__.getToken)();
      if (!token) {
...
function logOut() {
  return (0,_send_request__WEBPACK_IMPORTED_MODULE_0__["default"])("".concat(BASE_URL, "/logout"), 'POST');
}

// Function to update user data
function update(userId, userData) {
  return (0,_send_request__WEBPACK_IMPORTED_MODULE_0__["default"])("".concat(BASE_URL, "/").concat(userId), 'POST', userData);
}
...
function deletes(userId) {
  return (0,_send_request__WEBPACK_IMPORTED_MODULE_0__["default"])("".concat(BASE_URL, "/").concat(userId), 'DELETE');
}
...
/* harmony export */   logOut: () => (/* binding */ logOut)
/* harmony export */ });
/* unused harmony exports update, getAllUsers, deletes */
/* harmony import */ var _users_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./users-api */ "./src/utilities/users-api.js");
/* harmony import */ var _token__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./token */ "./src/utilities/token.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
// POST
function _create() {
  _create = _asyncToGenerator(function* (userData) {
    // Delete the network request code to the
    // users-api.js module which will ultimately
    // return the JWT
    const token = yield _users_api__WEBPACK_IMPORTED_MODULE_0__.create(userData);
    console.log(token);
...
function _logIn() {
  _logIn = _asyncToGenerator(function* (credentials) {
    return _users_api__WEBPACK_IMPORTED_MODULE_0__.logIn(credentials);
  });
  return _logIn.apply(this, arguments);
}
function logOut() {
...
function _logOut() {
  _logOut = _asyncToGenerator(function* () {
    return _users_api__WEBPACK_IMPORTED_MODULE_0__.logOut();
  });
  return _logOut.apply(this, arguments);
}
...
// GET
function _update() {
  _update = _asyncToGenerator(function* (id, updatedUserData) {
    // get a new token with updated user info
    const token = yield _users_api__WEBPACK_IMPORTED_MODULE_0__.update(id, updatedUserData);
...
function _getUser() {
  _getUser = _asyncToGenerator(function* () {
    const token = (0,_token__WEBPACK_IMPORTED_MODULE_1__.getToken)();
...
function _getAllUsers() {
  _getAllUsers = _asyncToGenerator(function* () {
    return _users_api__WEBPACK_IMPORTED_MODULE_0__.getAllUsers();
  });
  return _getAllUsers.apply(this, arguments);
}
function deletes(_x5) {
  return _deletes.apply(this, arguments);
}
function _deletes() {
  _deletes = _asyncToGenerator(function* (id) {
    // get a new token with updated user info
    const token = yield _users_api__WEBPACK_IMPORTED_MODULE_0__.deletes(id);
    // remove the current token from localStorage
    localStorage.removeItem('token');
    return getUser();
  });
...
.l8hJyaPvo9smd6LiNqWK li._scckhAN2KPE1u73kR14 {
  ...
  border: 0.1vmin solid var(--col-3);
}`, "",{"version":3,"sources":["webpack://./src/components/CategoryList/CategoryList.module.scss"],"names":[],"mappings":"AAAA;EACI,mBAAA;EACA,kBAAA;EACA,UAAA;EACA,iCAAA;EACA,cAAA;AACJ;;AAEI;EACA,gBAAA;EACA,gBAAA;EACA,sBAAA;EACA,sBAAA;AACJ;;AAEI;EACA,eAAA;EACA,6BAAA;EACA,mBAAA;AACJ;;AAEI;EACA,uBAAA;EACA,8BAAA;EACA,kCAAA;AACJ","sourcesContent":[".CategoryList {\n    color: var(--col-3);\n    list-style: circle;\n    padding: 0;\n    font-family: 'Roboto', sans-serif;\n    font-size: 2vw;\n    }\n    \n    .CategoryList li {\n    padding: .6vmin;\n    text-align: left;\n    border-radius: .5vmin;\n    margin-bottom: .5vmin;\n    }\n    \n    .CategoryList li:hover:not(.active) {\n    cursor: pointer;\n    background-color: var(--teal);\n    color: var(--white);\n    }\n    \n    .CategoryList li.active {\n    color: var(--text-dark);\n    background-color: var(--col-1);\n    border: .1vmin solid var(--col-3);\n    }"],"sourceRoot":""}]);
// Exports
...
___CSS_LOADER_EXPORT___.push([module.id, `.ZeRW57PNaWpYVsw6JlaC {
  ...
  border-top: 0.1vmin solid var(--col-3);
  font-size: 1.5vw;
}

.ZeRW57PNaWpYVsw6JlaC:last-child {
  border-bottom: 0.1vmin solid var(--col-3);
}
...
@keyframes A2PyFmnw5plg44L1SV6F {
  0%, 20%, 50%, 80%, 100% {
...
.EDeinQzfS2N2rVW_Z1GP {
  /* Other styles for your Logo component */
  /* Apply the animation to the Logo component */
  animation: A2PyFmnw5plg44L1SV6F 2s infinite;
}`, "",{"version":3,"sources":["webpack://./src/components/Logo/Logo.module.scss"],"names":[],"mappings":"AAAA;EACI,kBAAA;EACA,cAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,kBAAA;EACA,8BAAA;EACA,mBAAA;EACA,kBAAA;EACA,kBAAA;EACA,mCAAA;AACJ;;AAEA;EACI;IACE,wBAAA;EACJ;EACE;IACE,4BAAA;EACJ;EACE;IACE,2BAAA;EACJ;AACF;AAEE;EACE,yCAAA;EAEA,8CAAA;EACA,2CAAA;AADJ","sourcesContent":[".Logo {\n    margin: 20px 0 0 0;\n    height: 22vmin;\n    width: 32vmin;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    border-radius: 50%;\n    background-color: var(--col-8);\n    color: var(--col-1);\n    font-size: 4.6vmin;\n    font-weight: 2.5vm;\n    border: .4vmin dashed var(--col-7);\n    }\n\n@keyframes bounce {\n    0%, 20%, 50%, 80%, 100% {\n      transform: translateY(0);\n    }\n    40% {\n      transform: translateY(-10px);\n    }\n    60% {\n      transform: translateY(-5px);\n    }\n  }\n  \n  .Logo {\n    /* Other styles for your Logo component */\n    \n    /* Apply the animation to the Logo component */\n    animation: bounce 2s infinite;\n  }\n  "],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.X4tFBfG4MKknHvd01CKE .GqkE12RHPdZZg1360W4p {
  ...
  font-size: 4vw;
  background-color: var(--col-8);
  border: 0.1vmin solid var(--col-5);
  border-radius: 1vmin;
}
...
___CSS_LOADER_EXPORT___.push([module.id, `.l6Ner7C7O5I4V69HVVgW {
  ...
  align-items: center;
  background-color: var(--col-1);
  border: 0.1vmin solid var(--col-6);
  border-radius: 2vmin;
  margin: 3vmin 0;
  padding: 3vmin;
  overflow-y: scroll;
...
___CSS_LOADER_EXPORT___.push([module.id, `.SbDKL2bctOyC5ZgA0KfW {
  ...
  color: var(--text-light);
  background-color: var(--white);
  border: 0.2vmin solid var(--col-5);
  border-radius: 1vmin;
  font-size: 2vmin;
  cursor: pointer;
}
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[2].use[1]!./node_modules/sass-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/pages/AuthPage/AuthPage.modules.scss":
/*!*****************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[2].use[1]!./node_modules/sass-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/pages/AuthPage/AuthPage.modules.scss ***!
  \*****************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://i.imgur.com/PLjQbV9.jpeg);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.id, `/* AuthPage.module.scss */
.uJQHTsjyqdTGPYK_9XgD {
  margin: 20px;
  height: 100vh;
  display: flex;
  flex-direction: column;
  background-color: var(--white);
  background-image: url("https://i.imgur.com/PLjQbV9.jpeg");
  background-size: cover;
  background-repeat: no-repeat;
  background-position: center center;
  border-radius: 2vmin;
  border: 5px solid var(--col-7);
}

.Qc_8qjyuT_JIWVqbTPJV {
  display: flex;
  flex-direction: column;
  align-items: center;
  padding: 20px;
...
.Pa2gAHVWTftrTZirItRH {
  display: flex;
  justify-content: center;
  align-items: flex-end; /* Align images to center vertically */
  padding: 20px;
  margin-top: auto;
}

.LZoDp_dhFrIDHJ8X_O85 {
  flex: 1; /* Fill available space, pushing images to the bottom */
}

.LSJR6Ox1TafD_SmvxJNb {
  margin: 0 10px; /* Adjust margin between images */
}

.LSJR6Ox1TafD_SmvxJNb img {
  width: 200px; /* Adjust the image width */
  height: auto; /* Maintain aspect ratio */
  margin: 20px 0 0 5px; /* Adjust spacing between images */
  border: 2px solid var(--col-4);
  border-radius: 2vm;
}

.ZtzeMasO_XK2IAQJnoHP {
  margin-bottom: 20px;
}`, "",{"version":3,"sources":["webpack://./src/pages/AuthPage/AuthPage.modules.scss"],"names":[],"mappings":"AAAA,yBAAA;AAGA;EACE,YAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,8BAAA;EACA,yDAAA;EACA,sBAAA;EACA,4BAAA;EACA,kCAAA;EACA,oBAAA;EACA,8BAAA;AAAF;;AAIA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,aAAA;AADF;;AAKA;EACE,aAAA;EACA,uBAAA;EACA,qBAAA,EAAA,sCAAA;EACA,aAAA;EACA,gBAAA;AAFF;;AAKA;EACE,OAAA,EAAA,uDAAA;AAFF;;AAMA;EACE,cAAA,EAAA,iCAAA;AAHF;;AAMA;EACE,YAAA,EAAA,2BAAA;EACA,YAAA,EAAA,0BAAA;EACA,oBAAA,EAAA,kCAAA;EACA,8BAAA;EACA,kBAAA;AAHF;;AAMA;EACE,mBAAA;AAHF","sourcesContent":["/* AuthPage.module.scss */\n@import url('https://i.imgur.com/PLjQbV9.jpeg');\n\n.AuthPage {\n  margin: 20px;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  background-color: var(--white);\n  background-image: url('https://i.imgur.com/PLjQbV9.jpeg');\n  background-size: cover;\n  background-repeat: no-repeat;\n  background-position: center center;\n  border-radius: 2vmin;\n  border: 5px solid var(--col-7);\n}\n\n\n.AuthTop {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 20px;\n \n}\n\n.AuthBottom {\n  display: flex;\n  justify-content: center;\n  align-items: flex-end; /* Align images to center vertically */\n  padding: 20px;\n  margin-top: auto;\n}\n\n.AuthBottomSpacer {\n  flex: 1; /* Fill available space, pushing images to the bottom */\n}\n\n\n.ImageContainer {\n  margin: 0 10px; /* Adjust margin between images */\n}\n\n.ImageContainer img {\n  width: 200px; /* Adjust the image width */\n  height: auto; /* Maintain aspect ratio */\n  margin: 20px 0 0 5px; /* Adjust spacing between images */\n  border: 2px solid var(--col-4);\n  border-radius: 2vm;\n}\n\n.AuthPageLogo {\n  margin-bottom: 20px;\n}\n\n"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"AuthPage": `uJQHTsjyqdTGPYK_9XgD`,
	"AuthTop": `Qc_8qjyuT_JIWVqbTPJV`,
	"AuthBottom": `Pa2gAHVWTftrTZirItRH`,
	"AuthBottomSpacer": `LZoDp_dhFrIDHJ8X_O85`,
	"ImageContainer": `LSJR6Ox1TafD_SmvxJNb`,
	"AuthPageLogo": `ZtzeMasO_XK2IAQJnoHP`
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
.RZqTJBeYN7RXwcHgPFys aside {
  ...
  align-items: center;
  margin: 3vmin 2vmin;
}`, "",{"version":3,"sources":["webpack://./src/pages/NewOrderPage/NewOrderPage.module.scss"],"names":[],"mappings":"AAAA;EACI,YAAA;EACA,aAAA;EACA,sCAAA;EACA,uBAAA;EACA,8BAAA;EACA,oBAAA;EACA,yDAAA;EACA,0CAAA;EACA,8BAAA;EACA,sBAAA;AACJ;;AAEE;EACE,aAAA;EACA,sBAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;AACJ","sourcesContent":[".NewOrderPage {\n    height: 100%;\n    display: grid;\n    grid-template-columns: 1.6fr 3.5fr 3fr;\n    grid-template-rows: 1fr;\n    background-color: var(--col-4);\n    border-radius: 2vmin;\n    background-image: url('https://i.imgur.com/PLjQbV9.jpeg'); \n    background-color: rgba(255, 255, 255, 0.7); \n    background-blend-mode: overlay;\n    background-size: cover;\n  }\n\n  .NewOrderPage aside {\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    align-items: center;\n    margin: 3vmin 2vmin;\n  }\n\n  "],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.U7F51i6q23MB43wS4GeC .Gl976TgPIRmY9_yeWoZA {
  ...
  margin: 3vmin 2vmin;
  border-radius: 2vmin;
}`, "",{"version":3,"sources":["webpack://./src/pages/OrderHistoryPage/OrderHistoryPage.module.scss"],"names":[],"mappings":"AACA;EACE,YAAA;EACA,aAAA;EACA,sCAAA;EACA,uBAAA;EACA,8BAAA;EACA,oBAAA;EACA,yDAAA;EACA,0CAAA;EACA,8BAAA;EACA,sBAAA;AAAF;;AAIA;EACE,aAAA;EACA,sBAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;EACA,oBAAA;AADF","sourcesContent":["\n.OrderHistoryPage {\n  height: 100%;\n  display: grid;\n  grid-template-columns: 1.6fr 3.5fr 3fr;\n  grid-template-rows: 1fr;\n  background-color: var(--white);\n  border-radius: 2vmin;\n  background-image: url('https://i.imgur.com/PLjQbV9.jpeg'); \n  background-color: rgba(255, 255, 255, 0.7); \n  background-blend-mode: overlay;\n  background-size: cover;\n}\n\n\n.OrderHistoryPage .aside {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n  align-items: center;\n  margin: 3vmin 2vmin;\n  border-radius: 2vmin;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.OoRoUIaoCjHsXBK7EChZ {
  ...
  background-color: var(--col-1);
  color: var(--text-dark);
  border: 0.2vmin solid var(--col-6);
  border-radius: 1vmin;
  padding: 0.1vmin;
  text-align: center;
  font-size: 2vmin;
...
.MMHxHyV5UppwvI7obxXL {
  ...
  border: 0.3vmin solid var(--col-4);
  border-radius: 1vmin;
  color: var(--col-4);
}
...
input {
  padding: 1vmin;
  font-size: 2vmin;
  border: 0.1vmin solid var(--col-2);
  border-radius: 0.5vmin;
  color: var(--text-dark);
...
}`, "",{"version":3,"sources":["webpack://./src/scss/styles.scss"],"names":[],"mappings":"AAAA;EACE,gBAAA;EACA,gBAAA;EACA,gBAAA;EACA,gBAAA;EACA,gBAAA;EACA,gBAAA;EACA,gBAAA;EACA,gBAAA;EACA,gBAAA;EACA,eAAA;EACA,qBAAA;EACA,oBAAA;AACF;;AAEA;EACE,sBAAA;AACF;;AAEA;EACE,mCAAA;EACA,kCAAA;EACA,8BAAA;EACA,cAAA;EACA,aAAA;EACA,gCAAA;AACF;;AAGA;EACE,YAAA;AAAF;;AAGA;EACE,kBAAA;AAAF;;AAGA;EACE,iBAAA;AAAF;;AAGA;EACE,kBAAA;EACA,YAAA;AAAF;;AAGA;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,oBAAA;AAAF;;AAGA;EACE,sBAAA;EACA,oBAAA;AAAF;;AAGA;EACE,yBAAA;EACA,oBAAA;AAAF;;AAGA;EACE,kBAAA;EACA,oBAAA;AAAF;;AAGA;EACE,aAAA;EACA,6BAAA;EACA,mBAAA;EACA,8BAAA;EACA,uBAAA;EACA,kCAAA;EACA,oBAAA;EACA,gBAAA;EACA,kBAAA;EACA,gBAAA;AAAF;;AAGA;EACE,cAAA;EACA,8BAAA;EACA,kCAAA;EACA,oBAAA;EACA,mBAAA;AAAF;;AAGA;EACE,kBAAA;EACA,kBAAA;AAAF;;AAGA;EACE,aAAA;EACA,8BAAA;EACA,aAAA;EACA,mBAAA;AAAF;;AAGA;EACE,gBAAA;EACA,aAAA;EACA,mBAAA;AAAF;;AAGA;EACE,cAAA;EACA,gBAAA;EACA,kCAAA;EACA,sBAAA;EACA,uBAAA;EACA,iCAAA,EAAA,qBAAA;EACA,aAAA;AAAF;;AAGA;EACE,yBAAA;AAAF;;AAGA;EACE,aAAA;EACA,cAAA;EACA,mBAAA;EACA,6BAAA;EACA,gBAAA;EACA,iBAAA;EACA,qBAAA;EACA,kBAAA;EACA,kCAAA;EACA,sBAAA;EACA,aAAA;EACA,eAAA;AAAF;;AAGA;EACE,kBAAA;EACA,wBAAA;AAAF;;AAGA;EACE,gBAAA;EACA,wBAAA;AAAF;;AAGA;EACE,mBAAA;EACA,8BAAA;AAAF;;AAGA;EACE,mBAAA;EACA,iBAAA;AAAF;;AAIA;EACE,kCAAA;AADF","sourcesContent":[":root {\n  --white: #ffffff;\n  --col-1: #e5edf1;\n  --col-2: #005075;\n  --col-3: #615954;\n  --col-4: #00283a;\n  --col-5: #e7ebf5;\n  --col-6: #244146;\n  --col-7: #abb9bc;\n  --col-8: #6391a5;\n  --teal: #128178;\n  --text-light: #615954;\n  --text-dark: #615954;\n}\n\n*, *:before, *:after {\n  box-sizing: border-box;\n}\n\nbody {\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  background-color: var(--col-4);\n  padding: 4vmin;\n  height: 100vh;\n  font-family: 'Mooli', sans-serif;\n}\n\n\n#root {\n  height: 100%;\n}\n\n.align-ctr {\n  text-align: center;\n}\n\n.align-rt {\n  text-align: right;\n}\n\n.smaller {\n  font-size: smaller;\n  color: white;\n}\n\n.flex-ctr-ctr {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border-radius: 1vmin;\n}\n\n.flex-col {\n  flex-direction: column;\n  border-radius: 1vmin;\n}\n\n.flex-j-end {\n  justify-content: flex-end;\n  border-radius: 1vmin;\n}\n\n.scroll-y {\n  overflow-y: scroll;\n  border-radius: 1vmin;\n}\n\n.section-heading {\n  display: flex;\n  justify-content: space-around;\n  align-items: center;\n  background-color: var(--col-1);\n  color: var(--text-dark);\n  border: .2vmin solid var(--col-6);\n  border-radius: 1vmin;\n  padding: .1vmin;\n  text-align: center;\n  font-size: 2vmin;\n}\n\n.form-container {\n  padding: 3vmin;\n  background-color: var(--col-7);\n  border: .3vmin solid var(--col-4);\n  border-radius: 1vmin;\n  color: var(--col-4);\n}\n\np.error-message {\n  color: var(--teal);\n  text-align: center;\n}\n\nform {\n  display: grid;\n  grid-template-columns: 1fr 3fr;\n  gap: 1.25vmin;\n  color: var(--col-4);\n}\n\nlabel {\n  font-size: 2vmin;\n  display: flex;\n  align-items: center;\n}\n\ninput {\n  padding: 1vmin;\n  font-size: 2vmin;\n  border: .1vmin solid var(--col-2);\n  border-radius: .5vmin;\n  color: var(--text-dark);\n  background-image: none !important; /* prevent lastpass */\n  outline: none;\n}\n\ninput:focus {\n  border-color: var(--teal);\n}\n\nbutton, a.button {\n  margin: 1vmin;\n  padding: 1vmin;\n  color: var(--white);\n  background-color: var(--teal);\n  font-size: 2vmin;\n  font-weight: bold;\n  text-decoration: none;\n  text-align: center;\n  border: .1vmin solid var(--col-2);\n  border-radius: .5vmin;\n  outline: none;\n  cursor: pointer;\n}\n\nbutton.btn-sm {\n  font-size: 1.5vmin;\n  padding: .6vmin .8vmin;\n}\n\nbutton.btn-xs {\n  font-size: 1vmin;\n  padding: .4vmin .5vmin;\n}\n\nbutton:disabled, form:invalid button[type=\"submit\"] {\n  cursor: not-allowed;\n  background-color: var(--col-4);\n}\n\nbutton[type=\"submit\"] {\n  grid-column: span 2;\n  margin: 1vmin 0 0;\n}\n\n\nh1 {\n  font-family: 'Lobster', sans-serif;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
/***/ "./src/pages/AuthPage/AuthPage.modules.scss":
/*!**************************************************!*\
  !*** ./src/pages/AuthPage/AuthPage.modules.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_node_modules_sass_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[2].use[1]!../../../node_modules/sass-loader/dist/cjs.js!../../../node_modules/postcss-loader/dist/cjs.js!./AuthPage.modules.scss */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[2].use[1]!./node_modules/sass-loader/dist/cjs.js!./node_modules/postcss-loader/dist/cjs.js!./src/pages/AuthPage/AuthPage.modules.scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_node_modules_sass_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_node_modules_sass_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_node_modules_sass_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_2_use_1_node_modules_sass_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_AuthPage_modules_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/******/ })()
;
//# sourceMappingURL=App.12f54ac60695f94adbbabaad26ca95ac.js.map